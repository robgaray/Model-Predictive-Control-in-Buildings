...
# -------------------------------------------------------------
# Inputs
#   simulation_control : Named list. Must contain simulation_control$indexes_global$i0
#                        (Integer. Index of the current simulation step in Main_df)
#                        and simulation_control$indexes_global$i_end_horizon
#                        (Integer. Index of the last step of the forecast horizon
#                        in Main_df).
...
# -------------------------------------------------------------
# Usage instructions
# result <- context_forecast_step(simulation_control, time_sec, Main_df, parameters)
# -------------------------------------------------------------
...
# -------------------------------------------------------------
context_forecast_step <- function(simulation_control,
                                  time_sec,
                                  Main_df,
                                  parameters) {
  i0            <- simulation_control$indexes_global$i0
  i_end_horizon <- simulation_control$indexes_global$i_end_horizon
