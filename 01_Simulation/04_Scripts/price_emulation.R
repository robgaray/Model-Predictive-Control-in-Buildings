...
# randomly generated values based on the parameters in flex_price_simulation.csv.
...
# flex_price_sim_file : Character. Path to flex_price_simulation.csv.
# -------------------------------------------------------------
# Outputs
...

{
  ...
  flex_params              <- read.csv(flex_price_sim_file,
                                       comment.char = "#",
                                       strip.white = TRUE,
