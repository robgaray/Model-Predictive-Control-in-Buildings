...
# -------------------------------------------------------------
# Code outline
# 1. Copy plan columns to plan_flex columns
# 2. Set Q_heat and Q_cool to zero during flexibility window
# 3. Run period_calculation for plan_flex context
# -------------------------------------------------------------
# Usage instructions
# result_df <- flex_evaluation(period_chunk, parameters, i_flex, flexibility_event_length)
# -------------------------------------------------------------
# Where this function/script is used
# Called by evaluate_control.R during flexibility optimization.
# -------------------------------------------------------------
# EXCEPTIONS AND SPECIAL CASES:
#   - i_flex must be a single integer row index within period_chunk.
...
#     without any changes.
#   - All *_plan columns are copied to *_plan_flex before the subset
#     simulation so that rows outside the flexibility window keep the
#     plan values.
...
# -------------------------------------------------------------
flex_evaluation <- function(period_chunk, parameters, i_flex,
                            flexibility_event_length, flexibility) {
  ...
  # Copy *_plan columns to *_plan_flex
