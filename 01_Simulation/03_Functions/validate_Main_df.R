...
#   5. That binary flag columns (Occupancy, Act_vent, Act_heat,
#      Act_cool) contain only 0/1 values.
...
#   - If binary columns (Occupancy, Act_vent, Act_heat, Act_cool) contain
